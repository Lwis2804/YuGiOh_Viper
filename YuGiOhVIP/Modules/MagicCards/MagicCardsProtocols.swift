...
// MARK: VIEW -> PRESENTER
protocol MagicCards_ViewToPresenterProtocol: AnyObject {
	var view: MagicCards_PresenterToViewProtocol? { get set }
	var interactor: MagicCards_PresenterToInteractorProtocol? { get set }
	var router: MagicCards_PresenterToRouterProtocol? { get set }
}
...
protocol MagicCards_PresenterToInteractorProtocol: AnyObject {
    var presenter: MagicCards_InteractorToPresenterProtocol? { get set }
}
...
protocol MagicCards_InteractorToPresenterProtocol: AnyObject {
}
...
// MARK: PRESENTER -> VIEW
protocol MagicCards_PresenterToViewProtocol: AnyObject {
    var presenter: MagicCards_ViewToPresenterProtocol? { get set }
}
...
protocol MagicCards_PresenterToRouterProtocol: AnyObject {
}
