...
// MARK: VIEW -> PRESENTER
protocol PendulumCards_ViewToPresenterProtocol: AnyObject {
	var view: PendulumCards_PresenterToViewProtocol? { get set }
	var interactor: PendulumCards_PresenterToInteractorProtocol? { get set }
	var router: PendulumCards_PresenterToRouterProtocol? { get set }
}
...
protocol PendulumCards_PresenterToInteractorProtocol: AnyObject {
    var presenter: PendulumCards_InteractorToPresenterProtocol? { get set }
}
...
protocol PendulumCards_InteractorToPresenterProtocol: AnyObject {
}
...
// MARK: PRESENTER -> VIEW
protocol PendulumCards_PresenterToViewProtocol: AnyObject {
    var presenter: PendulumCards_ViewToPresenterProtocol? { get set }
}
...
protocol PendulumCards_PresenterToRouterProtocol: AnyObject {
}
