...
// MARK: VIEW -> PRESENTER
protocol TokenCards_ViewToPresenterProtocol: AnyObject {
	var view: TokenCards_PresenterToViewProtocol? { get set }
	var interactor: TokenCards_PresenterToInteractorProtocol? { get set }
	var router: TokenCards_PresenterToRouterProtocol? { get set }
}
...
protocol TokenCards_PresenterToInteractorProtocol: AnyObject {
    var presenter: TokenCards_InteractorToPresenterProtocol? { get set }
}
...
protocol TokenCards_InteractorToPresenterProtocol: AnyObject {
}
...
// MARK: PRESENTER -> VIEW
protocol TokenCards_PresenterToViewProtocol: AnyObject {
    var presenter: TokenCards_ViewToPresenterProtocol? { get set }
}
...
protocol TokenCards_PresenterToRouterProtocol: AnyObject {
}
